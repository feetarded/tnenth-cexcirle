...
#Dependencies:
# - Entity.gd (expects Entity to have fetch_resource method)
...
func _effect(entity : Entity):
	pass


func fetch_resource_from_entity(resource_types : Array[ResourceTypes.Global], entity : Entity):
	var resource_object_dict : Dictionary = {}
	
	for type in resource_types:
		var resource = entity.fetch_resource(type)
		if resource:
			resource_object_dict[type] = resource
